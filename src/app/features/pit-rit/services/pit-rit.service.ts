...
export interface PitData {
    ...
    atividades: {
        ensino: {
            aulas: { q1: number; q2: number; q3: number; t1: number; t2: number; t3: number };
            manutencao: { t4: number; t5: number };
            apoio: { t6: number };
            orientacao: { q7: number; q8: number; q9: number; q10: number; q11: number; t7: number; t8: number; t9: number; t10: number; t11: number };
            extracurricular: { q12: number; q13: number; t12: number; t13: number };
        };
        pesquisa: { q14: number; q15: number; q16: number; q17: number; q18: number; q19: number; q20: number; t14: number; t15: number; t16: number; t17: number; t18: number; t19: number; t20: number };
        extensao: { q21: number; q22: number; q23: number; q24: number; q25: number; q26: number; q27: number; q28: number; q29: number; t21: number; t22: number; t23: number; t24: number; t25: number; t26: number; t27: number; t28: number; t29: number };
        gestao: { q30: number; q31: number; q32: number; q33: number; q34: number; q35: number; q36: number; q37: number; t30: number; t31: number; t32: number; t33: number; t34: number; t35: number; t36: number; t37: number };
        comissoes: { q38: number; q39: number; q40: number; q41: number; q42: number; q43: number; q44: number; q45: number; q46: number; t38: number; t39: number; t40: number; t41: number; t42: number; t43: number; t44: number; t45: number; t46: number };
    };
    total: number;
}
...
export class PitRitService {
        ...
        return {
            ...
            atividades: {
                ensino: {
                    ...
                    apoio: { t6: 0 },
                    orientacao: { q7: 0, q8: 0, q9: 0, q10: 0, q11: 0, t7: 0, t8: 0, t9: 0, t10: 0, t11: 0 },
                    extracurricular: { q12: 0, q13: 0, t12: 0, t13: 0 }
                },
                pesquisa: { q14: 0, q15: 0, q16: 0, q17: 0, q18: 0, q19: 0, q20: 0, t14: 0, t15: 0, t16: 0, t17: 0, t18: 0, t19: 0, t20: 0 },
                extensao: { q21: 0, q22: 0, q23: 0, q24: 0, q25: 0, q26: 0, q27: 0, q28: 0, q29: 0, t21: 0, t22: 0, t23: 0, t24: 0, t25: 0, t26: 0, t27: 0, t28: 0, t29: 0 },
                gestao: { q30: 0, q31: 0, q32: 0, q33: 0, q34: 0, q35: 0, q36: 0, q37: 0, t30: 0, t31: 0, t32: 0, t33: 0, t34: 0, t35: 0, t36: 0, t37: 0 },
                comissoes: { q38: 0, q39: 0, q40: 0, q41: 0, q42: 0, q43: 0, q44: 0, q45: 0, q46: 0, t38: 0, t39: 0, t40: 0, t41: 0, t42: 0, t43: 0, t44: 0, t45: 0, t46: 0 }
            },
            total: 0
        } as any;
    }
    ...
    private getInitialRitData(): RitData {
        return {
            ...
            horarios: Array(12).fill(0).map(() => Array(5).fill(''))
        };
    }
    ...
    private calculatePitTotals() {
        ...
        const multipliers: { [key: string]: number } = {
            q1: 1, q2: 1, q3: 0.05,
            q7: 1, q8: 1, q9: 2, q10: 2, q11: 10,
            q12: 8, q13: 1,
            q14: 4, q15: 6, q16: 3, q17: 2, q18: 16, q19: 8, q20: 16,
            q21: 4, q22: 6, q23: 3, q24: 16, q25: 5, q26: 3, q27: 0.05, q28: 0.05, q29: 1,
            q30: 18, q31: 18, q32: 18, q33: 18, q34: 18, q35: 18, q36: 18, q37: 18,
            q38: 3, q39: 8, q40: 4, q41: 1, q42: 1, q43: 1, q44: 4, q45: 4, q46: 1
        };
        ...
        Object.keys(multipliers).forEach(qKey => {
            ...
            if (category && subCategory) {
                (data.atividades as any)[category][subCategory][qKey.replace('q', 't')] = (data.atividades as any)[category][subCategory][qKey] * multipliers[qKey];
            }
        });

        // Special calculations for Ensino (Maintenance and Support)
        const aulasTotal = data.atividades.ensino.aulas.t1 + data.atividades.ensino.aulas.t2 + data.atividades.ensino.aulas.t3;
