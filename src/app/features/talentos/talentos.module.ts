...
const SKILL_EMOJIS: Record<string, string> = {
  ...
  angular: '🔺', vue: '💚', java: '☕', 'c++': '⚙️', 'c#': '🟣',
  redes: '🌐', linux: '🐧', docker: '🐳', git: '🔀', kubernetes: '☸️',
  banco: '🗄️', sql: '🗄️', design: '🎨', figma: '🎨', ux: '🖌️', ui: '🖌️',
  machine: '🤖', ia: '🤖', 'inteligência': '🤖', segurança: '🔐', cloud: '☁️',
  nodejs: '🟢', php: '🐘', flutter: '🦋', kotlin: '🟠',
  swift: '🍎', rust: '🦀', go: '🔵', devops: '🚀', embedded: '📟',
  arduino: '📟', raspberry: '📟', microcontrolador: '📟',
  // — Engenharia Mecânica —
  mecânica: '⚙️', mecanica: '⚙️', cad: '📐', solidworks: '📐', autocad: '📐',
  usinagem: '🔩', manufatura: '🏭', soldagem: '🔥', cnc: '🔩',
  termodinâmica: '🌡️', termodinamica: '🌡️', fluidos: '💧', materiais: '🧱',
  // — Engenharia de Controle e Automação —
  automação: '🤖', automacao: '🤖', clp: '🖥️', plc: '🖥️', scada: '🖥️',
  elétrica: '⚡', eletrica: '⚡', eletrônica: '🔌', eletronica: '🔌',
  instrumentação: '📡', instrumentacao: '📡', controle: '🎛️', robótica: '🦾',
  robotica: '🦾', iot: '📡', sensores: '📡',
  // — Engenharia Ambiental e Sanitária —
  ambiental: '🌿', sanitária: '🌿', sanitaria: '🌿', saneamento: '💧',
  esgoto: '💧', resíduos: '♻️', residuos: '♻️', reciclagem: '♻️',
  sustentabilidade: '🌱', meio: '🌍', geotécnica: '🗺️', geotecnica: '🗺️',
  geoprocessamento: '🗺️', sig: '🗺️', gis: '🗺️', hidráulica: '💧',
  hidraulica: '💧', qualidade: '🧪', impacto: '🌍',
  // — Química —
  química: '🧪', quimica: '🧪', laboratório: '🔬', laboratorio: '🔬',
  análise: '🔬', analise: '🔬', cromatografia: '🧬', síntese: '⚗️',
  sintese: '⚗️', reação: '⚗️', reacao: '⚗️', orgânica: '🧬',
  organica: '🧬', inorgânica: '⚗️', inorganica: '⚗️', bioquímica: '🧬',
  bioquimica: '🧬', analítica: '🔬', analitica: '🔬',
  // — Matemática & Ciências —
  matemática: '📐', matematica: '📐', cálculo: '🧮', calculo: '🧮',
  álgebra: '🔢', algebra: '🔢', estatística: '📊', estatistica: '📊',
  probabilidade: '🎲', modelagem: '📊', simulação: '💻', simulacao: '💻',
  // — Habilidades Transversais —
  liderança: '👑', lideranca: '👑', gestão: '📋', gestao: '📋',
  projetos: '📋', scrum: '🔄', ágil: '🔄', agil: '🔄',
  pesquisa: '🔍', extensão: '🤝', extensao: '🤝', ensino: '📚',
  excel: '📊', power: '📊', office: '📊', comunicação: '🗣️',
  comunicacao: '🗣️', inglês: '🌎', ingles: '🌎', espanhol: '🌍',
};
...
@Component({
  ...
  template: `
    <main class="hub-container">
      ...
      <section class="hub-hero">
        ...
        <p class="hero-sub">
          De Computação à Engenharia, de Química à Matemática —
          conheça os estudantes e futuros profissionais do IFCE Maracanaú.
          Cada card é uma história. Cada habilidade é um superpoder.
        </p>
          ...
          <div class="card-face card-back">
            ...
            <div class="card-details-scroll">
              <div class="skills-cloud">
                <span
                  class="skill-tag"
                  *ngFor="let skill of t.skills"
                >{{ getEmoji(skill) }} {{ skill }}</span>
                <span *ngIf="!t.skills || t.skills.length === 0" class="skill-tag">💻 {{ t.superpoder }}</span>
              </div>
              ...
              <div class="detail-item" *ngIf="t.disponibilidade">
                <span class="detail-label">Disponibilidade:</span> {{ t.disponibilidade }}
              </div>
              <div class="detail-item" *ngIf="t.experiencia">
                <span class="detail-label">Experiência:</span> {{ t.experiencia }}
              </div>
              <div class="detail-item" *ngIf="t.idiomas && t.idiomas.length > 0">
                <span class="detail-label">Idiomas:</span> {{ t.idiomas.join(', ') }}
              </div>
            </div>
  ...
  styles: [`
    ...
    .talent-card.flipped .card-front { transform: rotateY(-180deg); }
    .talent-card.flipped .card-back  { transform: rotateY(0deg); }
    ...
    .card-face {
      ...
      transition: transform 0.5s ease, box-shadow 0.15s;
      overflow: hidden;
      display: flex;
      flex-direction: column;
    }
    ...
    .card-header-stripe {
      ...
      background: repeating-linear-gradient(
        90deg,
        #f5c842 0px, #f5c842 20px,
        #ff6b6b 20px, #ff6b6b 40px,
        #4ecdc4 40px, #4ecdc4 60px,
        #a29bfe 60px, #a29bfe 80px
      );
      flex-shrink: 0;
    }
    ...
    .detail-item { margin-bottom: 0.5rem; line-height: 1.3; }
    .detail-label { font-weight: 700; color: #f5c842; text-transform: uppercase; font-size: 0.7rem; display: block; }
    ...
    .github-btn  { background: #f5f0e8; color: #1a1a1a; }
    .linkedin-btn { background: #0077b5; color: #fff; }
    .cv-btn { background: #ff5e5e; color: #fff; border-color: #1a1a1a; }
    ...
    .cta-emoji { font-size: 2.5rem; flex-shrink: 0; }
